...
export default function StaffAttendance() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      const res = await getStaffCalendarView(orgId, monthParam);
  ...
  const exportToExcel = () => {
    ...
    saveAs(blob, `Staff-Attendance-${appliedYear}-${appliedMonth}.xlsx`);
  };
  ...
  return (
    <div className="w-full py-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Monthly Staff Attendance Record</CardTitle>
        </CardHeader>
