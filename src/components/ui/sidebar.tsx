    ...
    >
      ...
      >
        <div
          ...
          className="relative flex h-full w-full flex-col bg-linear-to-br from-secondary via-slate-800 to-slate-800
           text-white
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground dark:text-secondary-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
